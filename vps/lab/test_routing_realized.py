...
# 1) wave-factor shape: flat water = 1.0; degrades with Hs; upwind worse than downwind; floor honoured
...
print(f"     Hs=2m: upwind factor={up:.3f} downwind factor={down:.3f}")
check("waves slow the boat (factor < 1 in a seaway)", up < 1.0 and down < 1.0)
